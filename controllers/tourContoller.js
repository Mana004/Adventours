...
//     .limitFields()
//     .paginate();
//   const tours = await features.query; //the features.query will have  our query because in functions we are returning this
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  //check if defined properly in route
